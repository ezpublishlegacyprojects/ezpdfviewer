...
<input class="button" onclick="window.location.href='{$back_url|ezurl(no)}'" type="button" name="BackToNode" value="{'Back to edition'|i18n( 'ezpdfviewer/create' )}" title="{'Back to edition'|i18n( 'ezpdfviewer/create' )}" />
